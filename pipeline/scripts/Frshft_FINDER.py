...
class Intersection:
    ...
    def get_full_batch(self):
        ...
        return f"{self.global_orf_name}\t{self.global_orf}\t"\
                f"{self.dna_1_name}\t{self.dna_1}\t"\
                f"{self.dna_2_name}\t{self.dna_2}\t"\
                f"{self.inter_dna_1_name}\t{self.inter_dna_1}\t"\
                f"{self.inter_dna_2_name}\t{self.inter_dna_2}\t"\
                f"{self.prot_1_name}\t{self.prot_1}\t"\
                f"{self.prot_2_name}\t{self.prot_2}\t"\
                f"{self.inter_prot_1_name}\t{self.inter_prot_1}\t"\
                f"{self.inter_prot_2_name}\t{self.inter_prot_2}\n"
...
def main(args):
    ...
    with open(args.output, 'w') as w:
        w.write('GLOBAL_ORF\tGLOBAL_ORF_SEQ\tDNA_MAIN\tDNA_MAIN_SEQ\tDNA_ALT\tDNA_ALT_SEQ\t'+
                'INTERSECTION_DNA_MAIN\tINTERSECTION_DNA_MAIN_SEQ\tINTERSECTION_DNA_ALT\t INTERSECTION_DNA_ALT_SEQ\t'+\
                'PROT_MAIN\tPROT_MAIN_SEQ\tPROT_ALT\tPROT_ALT_SEQ\tPROT_INTERSECTED_MAIN\tPROT_INTERSECTED_MAIN_SEQ\tPROT_INTERSECTED_ALT\tPROT_INTERSECTED_ALT_SEQ\n')
